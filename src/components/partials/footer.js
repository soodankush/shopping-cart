import footerImage from "../../assets/images/about_1.jpg";
          ...
          <div className="row">
            <div className="col-md-6 col-lg-3 mb-4 mb-lg-0">
              ...
              <a href="/" className="block-6">
                <img src={footerImage} alt="ImageNew placeholder" className="img-fluid rounded mb-4" />
          ...
          <div className="row pt-5 mt-5 text-center">
            <div className="col-md-12">
              <p>
                ...
                href="https://colorlib.com" className="text-primary">Colorlib</a>
              </p>
            </div>
